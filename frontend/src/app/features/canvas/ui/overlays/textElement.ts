...
function showTextEditOverlay(
  ...
  const className = data.dom.classes.textEditOverlay;
  ...
  fontSelect.className = data.dom.classes.fontSelector;
...
export const textElementOverlayFns: TextElementOverlayFunctions = {
  show: showTextEditOverlay
} as const;
